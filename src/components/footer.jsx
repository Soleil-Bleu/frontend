...
export function Footer() {
    return (
        <section id="association" className="flex flex-col items-center justify-center p-8 pt-16">
            <div className="p-20 w-full rounded-lg bg-cover bg-center backdrop-brightness-200 bg-[url('friends.jpg')] flex flex-col items-center justify-center gap-8">
            ...
            grâce à sa facilité de mise en oeuvre. Pourtant, cette démocratisation se heurte à un paradoxe :
             ...
             et les analyses qui permettent d'optimiser les investissements sont hors de prix.
`}
                    </span>
                    <span className="font-secondary text-justify">
            ...
            `} <br />
                    ...
                    <a /* https://mailto.vercel.app/ */
                        href="mailto:sam.touvieille@gmail.com?subject=Contact%20b%C3%A9n%C3%A9vole%20%7C%20Soleil%20Bleu&body=Hello%2C%20je%20souhaite%20int%C3%A9grer%20l'association%20Soleil%20Bleu%2C%20prenons%20contact%20!"
                        className="font-secondary font-bold flex flex-row items-center justify-end underline underline-offset-2 col-span-2">
                        {"Adhérer à l'association/Devenir Bénévole "} <ArrowUpRight className="h-4 w-4 ml-1" />
                    </a>
                </div>
            </div>
